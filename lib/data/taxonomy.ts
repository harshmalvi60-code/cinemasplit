import { Emotion, MoodWorld } from '../types';
...
export const moodWorlds: MoodWorld[] = [
  ...
  },
  {
    ...
    number: '04',
    name: 'Social Anxiety',
    tagline: 'For when the room becomes a stage you never agreed to.',
    description:
      'Films for everyone whose nervous system reads connection as danger \u2014 and the slow, stubborn act of staying in the room anyway.',
    signature: '#b16a8a',
    emotions: [
      {
        slug: 'fear-of-connection',
        name: 'Fear of Connection',
        tagline: 'Films for the part of you that wants to be known and can\u2019t bear it.',
        editorial: `You want to be known. You also know, with bone-deep certainty, that if someone got close enough to actually know you, they would leave. So you build just enough warmth to seem approachable, and just enough distance to feel safe. And then you go home and feel the paradox of it. These films are for the nervous system that reads intimacy as danger — and for the stubborn, irrational part of you that keeps trying anyway. Not because the fear goes away. But because something keeps being worth the risk.`,
      },
    ],
    hero: `
  ...
  {
    slug: 'existential-confusion',
    number: '07',
    name: 'Existential Confusion',
    tagline: 'For the question that hasn\u2019t shut up since you turned twenty.',
    description:
      'Films for the moment the floor of certainty disappears \u2014 and the strange, vertigo-filled task of building a meaning that still holds you.',
    signature: '#88b8e8',
    emotions: [
      {
        slug: 'meaning-of-life',
        name: 'Meaning of Life',
        tagline: 'Films for the long stare at the size of the universe.',
        editorial: `The question arrived sometime after you were old enough to understand it and before you were ready to live with it. Why any of this? What makes a life matter? What do you owe the time you have been given? Philosophy courses give you frameworks. These films give you something different — they give you the question, held in a human life, breathed through an hour of real consequences. The best of them do not answer. They sit beside you in the not-knowing and demonstrate, by their very existence, that the asking is worthwhile.`,
      },
    ],
    hero: `
  ...
  },
  {
    ...
    number: '09',
    name: 'Inner Peace',
    tagline: 'For the quiet you\u2019ve been earning.',
    description:
      'Films for the days that don\u2019t need to be saved or solved \u2014 only inhabited. The slow art of letting the world be enough.',
    signature: '#9cb87a',
    emotions: [
      {
        slug: 'slowing-down',
        name: 'Slowing Down',
        tagline: 'Films for the day you stop arguing with the present.',
        editorial: `At some point — usually quietly, without announcement — you realise you have been in a hurry for years. Not going anywhere particular. Just moving fast, because speed felt like proof of something. These films are for the moment that speed runs out of argument. They are slow films. Not dull — slow with intention, the way a master craftsperson works with care instead of urgency. They show a life attended to rather than raced through. They are not prescriptions for how to live. They are invitations to notice that the present moment, patiently inhabited, is already enough.`,
      },
    ],
    hero: `
  ...
  },
  {
    ...
    tagline: 'For the part of you that\u2019s bigger than you.',
    description:
      'Films for the moment the small self steps aside \u2014 and something older, wider, and somehow more familiar walks through.',
    signature: '#c8a8e8',
    emotions: [
      {
        slug: 'beyond-ego',
        name: 'Beyond Ego',
        tagline: 'Films for the dissolution that turned out to be the door.',
        editorial: `Something shifted. You cannot explain it cleanly to anyone, and you have stopped trying. The self you used to perform — the one with a career arc and an opinion on everything and a very specific idea of what success looked like — feels less like who you are and more like a role you were assigned. This is disorienting. It is also, quietly, a kind of relief. The films here understand the sensation of outgrowing the container. They were made by people who noticed the same thing and turned it into something you can sit with for two hours and come out the other side changed.`,
      },
    ],
    hero: `
  ...
  },
  {
    ...
    number: '11',
    name: 'Hope',
    tagline: 'For the first line of light under the door.',
    description:
      'Films for the unreasonable conviction that something good is still possible \u2014 and the people whose lives become an argument for it.',
    signature: '#ffd87a',
    emotions: [
      {
        slug: 'light-after-darkness',
        name: 'Light After Darkness',
        tagline: 'Films for the morning that arrives anyway.',
        editorial: `You have been in the dark long enough that hope feels like a risk. Better to stay cautious. Better not to believe in things that might not come true. And then something happens — a line in a film, a stranger's act, a moment of ordinary grace — that makes the calculated caution feel less like wisdom and more like fear wearing a coat. These films are not motivational. They are not easy. They are arguments, carefully made, that hope is not naive — it is the most stubborn, evidence-based position available to a person who has been paying attention to how many mornings have arrived anyway.`,
      },
    ],
    hero: `
...
/** Total count of emotion pages across all worlds */
export const totalEmotions = moodWorlds.reduce((acc, w) => acc + w.emotions.length, 0);
